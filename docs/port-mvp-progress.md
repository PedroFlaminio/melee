...
câmera fica no estágio. Os lutadores já são desenhados, mas como planos
enormes de cor chapada que tomam a tela. O próximo passo é descobrir de onde
vêm esses planos (a matriz do lutador ou um passo de sombra, que acrescentou
views à captura) e depois ver os lutadores responderem ao stick e aos botões
(a pausa só prova que a entrada chega à cena). Sobram os relatos do UBSan, que a rota da luta multiplicou, e dois
