...
#ifdef MELEE_HOST
#define HSD_SYNTH_DEVCOM_ARG HSD_DevComArg
#else
#define HSD_SYNTH_DEVCOM_ARG int
#endif
...
/* 38AD60 */ void HSD_SynthResetStreamCounters(int, HSD_SYNTH_DEVCOM_ARG,
                                               void*, bool);
...
/* 38B3E0 */ void HSD_SynthPStreamHeaderCallback(int, HSD_SYNTH_DEVCOM_ARG, void*,
                                                 bool cancelflag);
